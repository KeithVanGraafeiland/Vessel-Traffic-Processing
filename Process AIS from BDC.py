...
if not os.path.exists(out_tracks_gdb):
    arcpy.management.CreateFileGDB(ROOT, os.path.basename(out_tracks_gdb), out_version='CURRENT')
...
def manage_attributes():
    ...
    # arcpy.management.AlterField(out_filtered_tracks, "VesselName", "vessel_name", "vessel name")
    arcpy.management.AlterField(out_tracks, "VesselType", VESSEL_TYPE, "vessel type")
    # arcpy.management.AlterField(out_filtered_tracks, "VesselType", VESSEL_TYPE, "vessel type")
...
def create_products():
    ...
    for x in valueList:
        ...
        # out_filtered_FC = MONTHLY_filtered_GDB + "\\" + YEAR_NAME + "_" + xname
        out_FC_month = YEAR_NAME + "_" + xname
        # out_filtered_FC_month = YEAR_NAME + "_" + xname
